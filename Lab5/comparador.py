...
class comparador(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "comparador", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "comparador")
        ...
        # Blocks
        ##################################################
        self._offset_range = Range(-2, 2, 0.01, 0, 200)
        ...
        self._A_range = Range(0, 5, 0.01, 1, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "amp", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*A, offset-A, 0)
    ...
    def set_offset(self, offset):
        self.offset = offset
        self.analog_sig_source_x_1.set_offset(self.offset-self.A)
...
def main(top_block_cls=comparador, options=None):
