...
class Demodulatorfm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Demodulatorfm")
        ...
        # Connections
        ##################################################
        self.connect((self.analog_fm_preemph_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
...
def main(top_block_cls=Demodulatorfm, options=None):
