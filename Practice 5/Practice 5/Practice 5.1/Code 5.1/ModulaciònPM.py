...
from EnvolventeComplejaPMG1 import EnvolventeComplejaPMG1  # grc-generated hier_block
...
class ModulaciònPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulaciònPM")
        ...
        self._Kp_range = Range(0, 100, 0.000001, 1, 200)
        self._Kp_win = RangeWidget(self._Kp_range, self.set_Kp, "Coeficiende Kp", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Kp_win)
        self._GTX_range = Range(0, 30, 1, 1, 200)
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia deñl transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.EnvolventeComplejaPMG1_1 = EnvolventeComplejaPMG1(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPMG1_1, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.EnvolventeComplejaPMG1_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPMG1_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPMG1_1, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventeComplejaPMG1_1, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.EnvolventeComplejaPMG1_1.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeComplejaPMG1_1.set_Ac(self.Ac)




def main(top_block_cls=ModulaciònPM, options=None):
