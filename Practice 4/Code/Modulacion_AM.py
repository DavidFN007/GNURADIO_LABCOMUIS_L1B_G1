...
class Modulacion_AM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulacion_AM")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 20000, A, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.CalculoPotenciaComunicaciones_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.ModuladorAM_0, 0))
...
def main(top_block_cls=Modulacion_AM, options=None):
